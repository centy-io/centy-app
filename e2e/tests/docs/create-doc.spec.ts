...
test.describe('Create Doc Form - Page rendering', () => {
  ...
  test('should render Cancel and Create Document buttons', async ({ page }) => {
    await setupDemoMode(page)
    await navigateToDemoProject(page, '/docs/new')
...
test.describe('Create Doc Form - Form interactions', () => {
  ...
  test('should update slug input value as the user types', async ({ page }) => {
    await setupDemoMode(page)
    await navigateToDemoProject(page, '/docs/new')
  ...
  test('should start with empty title, slug, and content', async ({ page }) => {
    await setupDemoMode(page)
    await navigateToDemoProject(page, '/docs/new')
...
test.describe('Create Doc Form - Draft persistence', () => {
...
test.describe('Create Doc Form - Cancel navigation', () => {
