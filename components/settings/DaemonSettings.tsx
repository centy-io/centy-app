...
function DaemonUrlInput({
  ...
  return (
    <div className="daemon-url-input">
      ...
      {!isDefault && <span className="custom-url-badge">Using custom URL</span>}
    </div>
  )
}

function DaemonHelpContent() {
  return (
    <div className="daemon-help">
      ...
      <ol>
        ...
        <li>
          <strong>Set the daemon URL above to your local daemon address</strong>{' '}
