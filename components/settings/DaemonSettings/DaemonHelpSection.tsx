import type { DaemonHelpProps } from './DaemonSettings.types'

export function DaemonHelpSection({ showHelp, onToggle }: DaemonHelpProps) {
  return (
    <>
      <button className="help-toggle" onClick={onToggle} type="button">
