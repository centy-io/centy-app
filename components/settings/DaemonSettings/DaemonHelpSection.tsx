function DaemonSetupSection() {
  return (
    <>
      ...
      <p className="daemon-help-text">To have the daemon start automatically when your machine boots:</p>
      <pre className="daemon-help-pre">
...
function DaemonExternalSection() {
  return (
    <>
      ...
      <ul className="daemon-help-list">
        ...
        <li className="daemon-help-list-item">Consider using HTTPS when exposing your daemon over the internet</li>
        <li className="daemon-help-list-item">
