...
declare module "nextjs-routes" {
  ...
  export type Route =
    | StaticRoute<"/">
    | DynamicRoute<"/[...path]", { "path": string[] }>
    | DynamicRoute<"/[organization]/[project]", { "organization": string; "project": string }>
    | DynamicRoute<"/[organization]/[project]/assets", { "organization": string; "project": string }>
    | DynamicRoute<"/[organization]/[project]/config", { "organization": string; "project": string }>
    | DynamicRoute<"/[organization]/[project]/docs", { "organization": string; "project": string }>
    | DynamicRoute<"/[organization]/[project]/docs/[slug]", { "organization": string; "project": string; "slug": string }>
    | DynamicRoute<"/[organization]/[project]/docs/new", { "organization": string; "project": string }>
